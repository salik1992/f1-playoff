...
export const InfoF1Playoff = () => (
    <>
        ...
        <Ul>
            <Li>Out of 32 seasons 16 would have the same champion.</Li>
            <Li>No champion of this era would loose champion status.</Li>
            <Li>
                Lewis Hamilton would still won 7 championship but some of them in different years.
            </Li>
            <Li>Michael Schumacher would be only 3 time world champion (1995, 2000, 2001).</Li>
            <Li>There would be a new world champion in 1992, Martin Brundle.</Li>
            <Li>
                In 2008 the controversial victory of Fernando Alonso in Singapore would gain him a
                2nd championship win out of 3. (2006, 2008 and 2012).
            </Li>
            <Li>Jenson Button would be crowned a champion in 2011 not 2009.</Li>
            <Li>Kimi Raikkonen would be 3 time world champion (2003, 2005, 2007).</Li>
            <Li>Sebastien Vettel would be only 2 time world champion in 2009 and 2013.</Li>
